 ...
 * @author ADMIN
 */
public class FormDuAn extends javax.swing.JPanel {

    DefaultTableModel d;
    private boolean them, sua;
    String file = "src/controller/DA.dat";
    List <DuAn> list = new ArrayList<>();
    public FormDuAn() {
        initComponents();
        them = false;
        sua = false;
        String [] cols = {"Ma du an", "Ten du an", "Kieu du an", "Tong kinh"
                + " phi"};
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jComboBox1, javax.swing.GroupLayout.Alignment.TRAILING, 0, 224, Short.MAX_VALUE)
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        if(list.size() > 0)
        {
            DuAn.setIds(list.get(list.size() - 1).getId() + 1);
        }
        jTextField1.setText(DuAn.getIds() + "");
        buttonState(false);
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        if(them)
        {
            ...
            try {
                ...
                long phi = Integer.parseInt(jTextField3.getText());
                if(ten.isEmpty())
                    throw new TrongException();
                DuAn temp = new DuAn(ma, ten, kieu, phi);
                list.add(temp);
        ...
        if(sua)
        {
            ...
            try {
                ...
                d.setValueAt(kieu, row, 2);
                d.setValueAt(phi, row, 3);
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Nhap vao so!");
                jTextField3.requestFocus();
            } catch (TrongException ex) {
