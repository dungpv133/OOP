...
public class FormMatHang extends javax.swing.JPanel {
    ...
    String file = "src/controller/MH.dat";
    ...
    public FormMatHang() {
        initComponents();
        String [] cols = {"Ma hang", "Ten hang", "Nhom hang", "Gia ban", "So luong"};
    ...
    private void loadData()
    {
        try {
            ...
            Logger.getLogger(FormMatHang.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        if(list.size() > 0)
        {
            MatHang.setIds(list.get(list.size() - 1).getId() + 1);
        }
        jTextField1.setText(MatHang.getIds() + "");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        if(them)
        {
            ...
            try {
                ...
                int so = Integer.parseInt(jTextField4.getText());
                if(nhom.isEmpty())
                    throw new TrongException();
                MatHang temp = new MatHang(id, ten, nhom, gia, so);
        ...
        if(sua)
        {
            ...
            try {
                ...
                d.setValueAt(nhom, row, 2);
                d.setValueAt(gia, row, 3);
                d.setValueAt(so, row, 4);
                list.set(row, temp);
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Nhap vao so!");
            } catch (TrongException ex) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jComboBox1.setSelectedItem(d.getValueAt(row, 2).toString());
        jTextField3.setText(d.getValueAt(row, 3).toString());
