...
public class FormMatHang extends javax.swing.JPanel {
    ...
    public FormMatHang() {
        initComponents();
        String [] cols = {"Ma hang", "Ten hang", "Nhom hang", "Gia ban"};
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        if(them)
        {
            try {
                ...
                MatHang temp = new MatHang(id, ten, nhom, gia);
                list.add(temp);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jComboBox1.setSelectedItem(d.getValueAt(dong, 2).toString());
        jTextField3.setText(d.getValueAt(dong, 3).toString());
